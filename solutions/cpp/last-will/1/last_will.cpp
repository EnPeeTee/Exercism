...
namespace estate_executor {
    int assemble_account_number(int secret_modifier) {
        int modifier = secret_modifier;
        int accountNumber = zhang::bank_number_part(modifier) + khan::bank_number_part(modifier) + garcia::bank_number_part(modifier);
        return accountNumber;
    }
    int assemble_code() {
        int redSum = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
        int blueSum = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
