...
bool can_eat_ghost(bool power_pellet_active, bool touching_ghost) {
    ...
    bool canEat = power_pellet_active && touching_ghost;
    return canEat;
}
...
bool scored(bool touching_power_pellet, bool touching_dot) {
    ...
    bool isTouching = touching_power_pellet || touching_dot;
    return isTouching;
}
...
bool lost(bool power_pellet_active, bool touching_ghost) {
    ...
    bool hasLost = !power_pellet_active && touching_ghost;
    return hasLost;
}
...
bool won(bool has_eaten_all_dots, bool power_pellet_active,
    ...
    bool hasWon = has_eaten_all_dots && !lost(power_pellet_active, touching_ghost);
    return hasWon;
}
